...
<form:form action="save" method="post" modelAttribute="formRegisterParticipation" id="formRegisterParticipation" name="formRegisterParticipation">
	<fieldset>
		...
		<div class="row">
			<div class="span9">			
				...
				<label>Nombre participaci&oacuten</label>
				<span class="obligatorio">*</span>
				<form:input path="nombreDeLaParticipacion"/>
				<spring:hasBindErrors name="formRegisterParticipation">
					<span class="label label-important">
						<form:errors path="nombreDeLaParticipacion" />
					</span>
				</spring:hasBindErrors>
				
				
				<label>Tipo participaci&oacuten</label>
				<span class="obligatorio">*</span>
				...
				<spring:hasBindErrors name="formRegisterParticipation">
					<span class="label label-important">
						<form:errors path="idTipoParticipacion" />
					</span>
				</spring:hasBindErrors>
