...
<div class="row">
	<div class="span12">		    		    
	    ...
	    Capacidades del congreso por universidad
	    <form id="form-university" method="get" action="${pageContext.request.contextPath}/resolver/activitie/report/count/for/university">
			<select id="id-university" name="id-university">
...
$(document).ready(function(){
	...
	$("#id-university > option[value=${param['id-university']}]").attr("selected", "selected");
	
	$("#id-university").change(function(){
		$("#form-university").submit();
	});
